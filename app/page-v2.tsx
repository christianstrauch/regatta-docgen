  ...
  async function loadDocument(id: number) {
    try {
      ...
      if (response.ok) {
        ...
        setFleets(JSON.parse(doc.fleets))
        setFleetProvisions(JSON.parse(doc.fleets).provisions || [])
        ...
        <Tabs defaultValue="details" className="space-y-6">
          ...
          <TabsContent value="rules" className="space-y-4">
            <Card className="p-6">
              ...
              <p className="text-sm text-muted-foreground mb-6">
                Select and customize the Racing Rules of Sailing (2025-2028) and US Sailing Prescriptions.
              </p>
              <RulesSelector
          ...
          <TabsContent value="custom" className="space-y-4">
            <Card className="p-6">
              ...
              <p className="text-sm text-muted-foreground mb-6">
                Add any additional custom fields and information.
              </p>
              <CustomFieldsForm fields={customFields} onChange={setCustomFields} />
            </Card>
          </TabsContent>
